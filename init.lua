...
require('lazy').setup {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sc', ':TodoTelescope<enter>', { desc = '[S]earch [C]omments' })
  ...
  -- TODO: look into 'kickstart.plugins.neo-tree'
  ...
  {
    -- TODO: see how we can open a panel like in VS C**e
